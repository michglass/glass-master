...
public class CardScroller extends CardScrollAdapter {
     ...
     * @param persons Friends, Family info
     * @param context Activity where Cards will be displayed
     */
    public void createCards(ArrayList<Person> persons, Context context) {
        Log.v(TAG, "Create Cards");
        // placeholder card
        Card currCard;
        for(Person person: persons) {
            currCard = new Card(context);
            currCard.setText(person.getName());
     ...
     * @param context Activity where Cards will be displayed
     */
    public void createCards(Queue<String> messages, Context context) {
        Log.v(TAG, "Create Cards");
        // placeholder card
        Card currCard;
